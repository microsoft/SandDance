...
def sanddance(df: pd.DataFrame, key: Optional[str] = None, insight: Optional[Insight] = None, explorerProps: Optional[ExplorerProps] = None, height: int = 700) -> int:
    ...
    height (int, optional): The height of the component in pixels. If not provided, a default height of 700 will be used.
    ...
    # dictionary.
    component_value = _component_func(records=df.to_dict(orient='records'), key=key, default=None, insight=insight, explorerProps=explorerProps, height=height)
