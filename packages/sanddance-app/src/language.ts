...
export const strings = {
    ...
    menuUrl: 'Enter a URL ...',
    menuExportSnapshotsDialog: 'Export ...',
    menuImportSnapshotsDialog: 'Import ...',
    menuSnapshotExportJson: 'As snapshots file, for importing later',
    menuSnapshotExportMarkdown: 'As Markdown file, for blogging',
    menuSnapshotsImportFile: 'Import snapshots',
    menuSnapshotsImportUrl: 'Import snapshots',
    ...
    labelExportSnapshots: 'Export snapshots',//DELETE
    labelImportSnapshots: 'Import snapshots',//DELETE
    labelLink: 'link',
    labelUrl: 'Url',
